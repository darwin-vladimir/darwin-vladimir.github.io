const AVAILABLE_WEEK_DAYS = ['Domingo', 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado'];
...
// App methods
    ...
    drawEvents() {
        ...
        let eventList = this.eventList[calendar.active.formatted] || ['No existe ningun evento'];
        let eventTemplate = "";
